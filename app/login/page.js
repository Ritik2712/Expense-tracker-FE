  ...
  return (
    <main className="mx-auto grid min-h-screen w-full max-w-7xl place-items-center px-4 py-10 sm:px-6">
      <div className="w-full max-w-md rounded-2xl border border-black/15 bg-white p-6 shadow-lg shadow-black/10">
        ...
        <h1 className="mb-1 text-3xl font-semibold tracking-tight text-black">Login</h1>
        <p className="mb-6 text-sm text-black/60">Sign in to your account.</p>
        ...
        <div className="mt-5 space-y-2 text-sm text-black">
          <p>
            No account?{' '}
            <Link className="border-b border-black/40 pb-0.5 hover:border-black" href="/register">
              Register user
            </Link>
          </p>
          <p>
            Need admin?{' '}
            <Link className="border-b border-black/40 pb-0.5 hover:border-black" href="/register-admin">
              Register admin
            </Link>
          </p>
        </div>
